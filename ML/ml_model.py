...
def preProcessData():
	...
	print(feats[91],feats[92],feats[18],feats[124],feats[102],feats[101],feats[135],feats[59],feats[133],feats[25])
...
rf = RandomForestRegressor(n_estimators = 200, random_state = 17,min_samples_split=2,min_samples_leaf=1)
# rf = BaggingRegressor(n_estimators = 400, random_state = 17)
...
# 	rev_model.fit(train_feat, train_labels,validation_data=(test_feat,test_labels), epochs=500, batch_size=16)
# 	rev_model.save('models/revenue_model.h5')
