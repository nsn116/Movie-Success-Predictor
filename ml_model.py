...
labels = df[['vote_average','revenue']]
...
# print(labels['vote_average'].describe())
...
model = Sequential()
model.add(Dense(128, input_dim=train_feat.shape[1], activation='relu'))
...
model.fit(train_feat, train_labels,validation_data=(test_feat,test_labels), epochs=500, batch_size=64)
